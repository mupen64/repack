...
return {
    ...
    TAS_GOAL_ANGLE_TOOLTIP = 'Indique l\'angle à maintenir avec\nAngle',
    TAS_DYAW_TOOLTIP = 'Utilise l\'angle comme décalage par rapport à\nl\'angle actuel de Mario',
    TAS_STRAIN_LEFT_TOOLTIP = 'Applique un strain vers la gauche',
    TAS_STRAIN_RIGHT_TOOLTIP = 'Applique un strain vers la droite',
    TAS_D99_TOOLTIP = 'Tente de maintenir la vitesse de Mario à 31.99 ou 47.99\npendant une frame',
    TAS_D99_ALWAYS_TOOLTIP = 'Applique constamment la méthode de strain .99',
...
Cette action est irréversible.
    ...
    TOOLS_RNG_LOCK_TOOLTIP = 'Remplace le RNG du jeu par la valeur\ndu champ voisin',
    TOOLS_RNG_VALUE_TOOLTIP = 'Index ou valeur RNG à utiliser',
    TOOLS_RNG_USE_INDEX_TOOLTIP = 'Traite le champ voisin comme un index RNG\nplutôt qu\'une valeur',
    TOOLS_DUMPING = 'Export',
    TOOLS_DUMPING_TOOLTIP = 'Écrit l\'état du script dans dump.json à chaque frame\nlorsque cette option est activée',
    TOOLS_EXPERIMENTS = 'Expériences',
    TOOLS_GHOST = 'Fantôme',
    TOOLS_GHOST_OBJECT_ADDRESS_TOOL_TIP  = 'Adresse de l’objet à enregistrer (par exemple 8033FF48)\nSi 0, Mario est enregistré',
    TOOLS_GHOST_START = 'Démarrer rec.',
    TOOLS_GHOST_STOP = 'Arrêter rec.',
    TOOLS_GHOST_RECORD_TOOLTIP = 'Enregistre un fichier fantôme lisible dans STROOP',
    ...
    TOOLS_MOVED_DIST_TOOLTIP = 'Affiche la distance depuis la position de Mario\nau début du suivi',
    TOOLS_MOVED_DIST_X_TOOLTIP = 'Inclut le déplacement sur l\'axe X dans Distance',
    TOOLS_MOVED_DIST_Y_TOOLTIP = 'Inclut le déplacement sur l\'axe Y dans Distance',
    TOOLS_MOVED_DIST_Z_TOOLTIP = 'Inclut le déplacement sur l\'axe Z dans Distance',
    TOOLS_MINI_OVERLAY = 'Saisie en jeu',
    TOOLS_MINI_OVERLAY_TOOLTIP = 'Affiche les inputs actuels de la manette en superposition',
    TOOLS_AUTO_FIRSTIES = 'Auto-firsties',
    TOOLS_AUTO_FIRSTIES_TOOLTIP = 'Appuie sur A à la première frame\nd\'un wallkick',
    TOOLS_WORLD_VISUALIZER = 'Visu. monde',
    TOOLS_WORLD_VISUALIZER_TOOLTIP = 'Affiche des informations sur le monde du jeu\nen superposition',
    FRAMEWALK_TOOLTIP = 'Met le joystick à zéro une frame sur deux',
    SWIM_TOOLTIP = 'Nage automatiquement et optimalement sous l\'eau',
    -- Timer Tab
