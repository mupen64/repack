...
return {
    ...
    TAS_GOAL_ANGLE_TOOLTIP = 'Specifies the angle to hold when\nMatch Angle is enabled',
    TAS_DYAW_TOOLTIP = 'Uses the angle as an offset from\nMario\'s current angle',
    TAS_STRAIN_LEFT_TOOLTIP = 'Applies leftward strain',
    TAS_STRAIN_RIGHT_TOOLTIP = 'Applies rightward strain',
    TAS_D99_TOOLTIP = 'Attempts to hold Mario\'s speed at 31.99 or 47.99\nfor one frame',
    TAS_D99_ALWAYS_TOOLTIP = 'Applies the .99 strain method constantly',
...
This action cannot be undone.
    ...
    TOOLS_RNG_LOCK_TOOLTIP = 'Override the game RNG with the value\nin the adjacent field',
    TOOLS_RNG_VALUE_TOOLTIP = 'The RNG index or value to use',
    TOOLS_RNG_USE_INDEX_TOOLTIP = 'Treat the adjacent field as an RNG index\ninstead of a value',
    TOOLS_DUMPING = 'Dumping',
    TOOLS_DUMPING_TOOLTIP = 'Write the script state to dump.json every frame\nwhile enabled',
    TOOLS_GHOST = 'Ghost',
    TOOLS_GHOST_OBJECT_ADDRESS_TOOL_TIP = 'Address of the object to record (e.g. 8033FF48)\nIf 0, Mario is recorded',
    TOOLS_GHOST_START = 'Start Recording',
    TOOLS_GHOST_STOP = 'Stop Recording',
    TOOLS_GHOST_RECORD_TOOLTIP = 'Record a ghost file for playback in STROOP',
    ...
    TOOLS_MOVED_DIST_TOOLTIP = 'Show the distance from Mario\'s position\nwhen tracking was enabled',
    TOOLS_MOVED_DIST_X_TOOLTIP = 'Include Mario\'s X-axis movement in Moved Dist',
    TOOLS_MOVED_DIST_Y_TOOLTIP = 'Include Mario\'s Y-axis movement in Moved Dist',
    TOOLS_MOVED_DIST_Z_TOOLTIP = 'Include Mario\'s Z-axis movement in Moved Dist',
    TOOLS_MINI_OVERLAY = 'Input Overlay',
    TOOLS_MINI_OVERLAY_TOOLTIP = 'Show the current controller input as an overlay',
    TOOLS_AUTO_FIRSTIES = 'Auto-firsties',
    TOOLS_AUTO_FIRSTIES_TOOLTIP = 'Press A on the first frame\nof a wallkick',
    TOOLS_WORLD_VISUALIZER = 'World Visualizer',
    TOOLS_WORLD_VISUALIZER_TOOLTIP = 'Show information about the game world\nas an overlay',
    FRAMEWALK_TOOLTIP = 'Zero the joystick every other frame',
    SWIM_TOOLTIP = 'Swim automatically and optimally while underwater',
    -- Timer Tab
    TIMER_START = 'Start',
    TIMER_STOP = 'Stop',
    TIMER_RESET = 'Reset',
